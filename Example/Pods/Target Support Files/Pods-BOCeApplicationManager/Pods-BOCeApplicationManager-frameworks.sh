...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AEGuideView/AEGuideView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BOCeNetManager/BOCeNetManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BOCeUpImageManager/BOCeUpImageManager.framework"
