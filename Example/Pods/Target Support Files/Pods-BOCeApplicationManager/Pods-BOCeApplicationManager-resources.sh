...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/AlicloudRPSDK/cro-rpsdk/RPSDK.framework/RPSDK.bundle"
  install_resource "${PODS_ROOT}/AlipaySDK-iOS/AlipaySDK.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/BOCeApplicationManager/BOCeApplicationManager.bundle"
